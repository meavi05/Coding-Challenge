...
class Result {
	 ...
	 * 
	 * For the unweighted graph, <name>: 1. The number of nodes is <name>Nodes. 2.
	 * The number of edges is <name>Edges. 3. An edge exists between <name>From[i]
	 * and <name>To[i].
	 * 
	 * @param cityNodes
	 * @param cityFrom
...
public class DeliveryManagementSystem_BFS {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader bufferedReader = new BufferedReader(
				(new FileReader("resources\\DeliveryManagementSystem_BFS_Input.txt")));
